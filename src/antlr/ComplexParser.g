...
funct_ref2
  ...
  | BINARY_FN_AND LEFT_PAREN a = expr ARG_SEPARATOR b = expr RIGHT_PAREN -> ^(FUNCTION BINARY_FN_AND $a $b)
  | BINARY_FN_OR LEFT_PAREN a = expr ARG_SEPARATOR b = expr RIGHT_PAREN -> ^(FUNCTION BINARY_FN_OR $a $b)
  | BINARY_FN_NOT LEFT_PAREN a = expr RIGHT_PAREN -> ^(FUNCTION BINARY_FN_NOT $a)
  | BINARY_FN_NAND LEFT_PAREN a = expr ARG_SEPARATOR b = expr RIGHT_PAREN -> ^(FUNCTION BINARY_FN_NAND $a $b)
